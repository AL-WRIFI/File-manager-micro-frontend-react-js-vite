...
export default function Theme(){
    ...
    function changeColor(i){
        ...
        setPrimaryColor(i);
        setSettings(_settings);
        dispatch(changePreferredColor(_color)); 
    }
    ...
    return (
        <div className="tab-pane fade " id="theme">
            <div className="section d-block">
                <h2>Primary Theme</h2>
                <div className="options-container">
                    <div className="option light" onClick={() => changeThemeColor(0)}>
                        { theme === "light" && (
                            <div className="check">
                    ...
                    <div className="option dark" onClick={() => changeThemeColor(1)}>
                        { theme === "dark" && (
                            <div className="check">
                                <FontAwesomeIcon icon={faCheck} />
                            </div>
